...
/**
 * contentEditable 光标/选区/提及标记工具集。
 * 从 InputBar.tsx 提取（#24 拆单体）——纯 DOM 操作，无 React 依赖。
 * 与 contentEditableMentions.ts 的关系：那个模块处理提及的插入/删除/解析，
 * 这里处理光标位置、选区范围和 HTML 渲染——两者互补不重复。
 */
